...
Es importante considerar la simbología constantemente a lo largo de este material. [Ir al glosario](./mc_glos.qmd#tbl-simbol-pure).
...
|------------------------|-----------------|---------------------|
| Energía interna        | $d\underline{U} = Td\underline{S}-Pd\underline{V}$  | $\underline{U}(S,~\underline{V})$           |
| Energía de Helmholtz   | $d\underline{A} = -\underline{S}dT-Pd\underline{V}$ | $\underline{A}(T,~\underline{V})$           |
| Entalpía               | $d\underline{H} = Td\underline{S}+\underline{V}dP$  | $\underline{H}(\underline{S},~P)$           |
| Energía libre de Gibbs | $d\underline{G} = -\underline{S}dT+\underline{V}dP$ | $\underline{G}(T,~P)$           |

: Ecuaciones fundamentales {#tbl-ecfundamentales .hover}
...
## Ejemplo: Diagrama PV para CO$_2$ {#sec-CO2}
...
Cálculo de alguna propiedad termodinámica a partir del balance de energía de un sistema. Luego el alumno resuelve dicho sistema utilizando alguna EOS simple. (VdW por ejemplo). "A partir del balance de energía dervie una expresión para un sistema cerrado blablabla, luego resuelva X propiedad a la salida del sistema usando VdW o RK o PR"
